...
const PREFILL_TEXT = 'Olá! Vim pelo site da Artificial Studio e quero saber mais sobre os serviços.'

// Glifo oficial do WhatsApp (lucide-react não tem o logo da marca).
...
export default function WhatsAppButton() {
  return (
    <a
      href={waLink(PREFILL_TEXT)}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Falar no WhatsApp"
      onClick={() => window.gtag?.('event', 'whatsapp_float_click')}
